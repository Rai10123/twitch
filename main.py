...
twitch_miner = TwitchChannelPointsMiner(
    username=os.environ.get('00_vegas_00'),
    password=os.environ.get('270584Nikita1'),           # If no password will be provided, the script will ask interactively
